...
Utilizado para converter a entrada do usuario em uma \hyperlink{classCommandLine}{CommandLine}. A linha de usuario deve ter a seguinte forma $<$comando$>$$<$paramentro$>$...$<$parametro$>$$|$...$|$$<$comando$>$...\mbox{[}$<$ $<$entrada$>$\mbox{]}\mbox{[}\mbox{[}1$>$$|$$>$$|$$>$$>$\mbox{]}\mbox{[}2$>$\mbox{]}$<$saida$>$$|$\&$>$$<$saida$>$\mbox{]}\mbox{[}\&\mbox{]} 
